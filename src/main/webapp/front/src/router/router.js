...
import xuefeijiaonaList from '../pages/xuefeijiaona/list'
import xuefeijiaonaDetail from '../pages/xuefeijiaona/detail'
import xuefeijiaonaAdd from '../pages/xuefeijiaona/add'
import shishengduihuaList from '../pages/shishengduihua/list'
import shishengduihuaDetail from '../pages/shishengduihua/detail'
import shishengduihuaAdd from '../pages/shishengduihua/add'
      ...
      redirect: '/index/home'
    },
		{
			...
			children:[
				...
				{
					path: 'xuefeijiaona',
					component: xuefeijiaonaList
				},
				{
					path: 'xuefeijiaonaDetail',
					component: xuefeijiaonaDetail
				},
				{
					path: 'xuefeijiaonaAdd',
					component: xuefeijiaonaAdd
				},
				{
					path: 'shishengduihua',
					component: shishengduihuaList
				},
				{
					path: 'shishengduihuaDetail',
					component: shishengduihuaDetail
				},
				{
					path: 'shishengduihuaAdd',
					component: shishengduihuaAdd
				},
				{
					path: 'aboutus',
