...
import center from '@/views/center'
    ...
    import shishengduihua from '@/views/modules/shishengduihua/list'
    import kaojixinxi from '@/views/modules/kaojixinxi/list'
    import xuefeijiaona from '@/views/modules/xuefeijiaona/list'
